...
import com.pinnet.chargerapp.widget.WaveLoadingView;
...
public class ChargerChargingActivity extends BaseActivity<ChargerChargingPresenter> implements ChargerChargingContract.View {
    private static final String TAG = "ChargerChargingActivity";
    /**
     * 水波动画
     */
    ...
    protected int getLayoutId() {
        return R.layout.charger_charging_activity;
    }
    ...
    protected void onInitView() {
        ...
        getIntentData();
        mWaveView.setAnimDuration(4000);
        mWaveView.setCenterTitle(String.valueOf(0));
        mWaveView.setCenterTitleSize(60);
    ...
    private void resetUiData() {
        ...
        mWaveView.setCenterTitle(DataUtils.getInstance().round(mChargingBean.getProgress(), 2));
        mWaveView.setProgressValue(mChargingBean.getProgress());
    }
