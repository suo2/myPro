package com.pinnet.chargerapp.third.citypicker.view;
...
public class SideIndexBar extends View {
    ...
    private int mTextSizeSection;      //sp
    ...
    private void init(Context context) {
        ...
        mTextSizeSection = context.getResources().getDimensionPixelSize(R.dimen.cp_section_text_size);
        ...
        mTouchedPaint.setTextSize(mTextSizeSection);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mItemHeight = (float) mHeight / mIndexItems.size();
