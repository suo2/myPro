...
public class WaveLoadingView extends View {
    ...
    private int mWaveColorGradient;
    ...
    private String mCenterUnit = "%";
    private String mBottomTitle;
    private float mDefaultWaterLevel;
    private float mWaterLevelRatio = 1f;
    private float mWaveShiftRatio = DEFAULT_WAVE_SHIFT_RATIO;
    private double mProgressValue = DEFAULT_WAVE_PROGRESS_VALUE;
    ...
    private Paint mCenterTitleUnitPaint;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWaveColorGradient = attributes.getColor(R.styleable.WaveLoadingView_wlv_waveColor_gradient, DEFAULT_WAVE_COLOR);
        ...
        // Init Center Title
        mCenterTitleUnitPaint = new Paint();
        mCenterTitleUnitPaint.setColor(attributes.getColor(R.styleable.WaveLoadingView_wlv_titleCenterColor, DEFAULT_TITLE_COLOR));
        mCenterTitleUnitPaint.setStyle(Paint.Style.FILL);
        mCenterTitleUnitPaint.setAntiAlias(true);
        mCenterTitleUnitPaint.setTextSize(attributes.getDimension(R.styleable.WaveLoadingView_wlv_titleCenterSize, sp2px(DEFAULT_TITLE_CENTER_SIZE)));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mWaveShader != null) {
            ...
            if (!TextUtils.isEmpty(mCenterTitle)) {
                ...
                mCenterTitlePaint.getTextBounds(mCenterTitle, 0, mCenterTitle.length(), centerRect);
                canvas.drawText("%", (getWidth() - middle) / 2 + centerRect.width() + 20,
                        getHeight() / 2 - ((mCenterTitlePaint.descent() + mCenterTitlePaint.ascent()) / 2), mCenterTitleUnitPaint);
            }
    ...
    private void updateWaveShader() {
        ...
        if (bitmapBuffer == null || haveBoundsChanged()) {
            ...
            if (width > 0 && height > 0) {
                ...
                //渐变色
                LinearGradient linearGradient = new LinearGradient(0, 0, 0, endY,
                        mWaveColorGradient, mWaveColor, LinearGradient.TileMode.CLAMP);
