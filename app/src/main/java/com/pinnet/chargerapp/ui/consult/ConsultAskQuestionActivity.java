...
public class ConsultAskQuestionActivity extends BaseActivity<ConsultHomePresenter> implements ConsultHomeContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.consult_ask_question_activity;
    }

    @Override
    protected void onInitView() {
        super.onInitView();
        tvHeaderTitle.setText(R.string.consult_tip_ask);
